 ...
 */
@Injectable()
export class DatasetRequirementService {
    /**
    ...
    async find(
        ...
        return await bgTask.context.datastore.datasetRequirement.find(
    ...
    async total(
        ...
        return await bgTask.context.datastore.datasetRequirement.total(
            queryParam.queryFilter
        )
    }
}
