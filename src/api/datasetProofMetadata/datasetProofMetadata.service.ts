 ...
 */
@Injectable()
export class DatasetProofMetadataService {
    /**
    ...
    async find(
        ...
        return await bgTask.context.datastore.datasetProofMetadata.find(
    ...
    async total(
        ...
        return await bgTask.context.datastore.datasetProofMetadata.total(
            queryParam.queryFilter
        )
    }
}
