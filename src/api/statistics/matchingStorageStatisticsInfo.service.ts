 ...
 */
@Injectable()
export class MatchingStorageStatisticsInfoService {
    /**
     * Gets a greeting message.
     * @returns A string representing a greeting message.
     */
    async find(
        queryParam: QueryParam<MatchingStorageStatisticsInfo>
        ...
        return await bgTask.context.datastore.matchingStorageStatisticsInfo.find(
    ...
    async total(
        ...
        return await bgTask.context.datastore.matchingStorageStatisticsInfo.total(
            queryParam.queryFilter
        )
    }
}
