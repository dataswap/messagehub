 ...
 */
@Injectable()
export class MatchingsStatisticsService {
    /**
    ...
    async find(
        ...
        return await bgTask.context.datastore.matchingsStatistics.find(
    ...
    async total(
        ...
        return await bgTask.context.datastore.matchingsStatistics.total(
            queryParam.queryFilter
        )
    }
}
