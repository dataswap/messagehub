...
import { CarReplicaService } from "./carReplica.service"
...
@Controller("carreplica")
export class CarReplicaController {
    /**
     * Creates an instance of RootController.
     * @param rootService - The RootService instance.
     */
    constructor(private readonly carReplicaService: CarReplicaService) {}
