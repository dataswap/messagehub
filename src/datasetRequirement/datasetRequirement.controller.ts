...
import { DatasetRequirementService } from "./datasetRequirement.service"
...
@Controller("datasetrequirement")
export class DatasetRequirementController {
    /**
     * Creates an instance of RootController.
     * @param rootService - The RootService instance.
     */
    constructor(
        private readonly datasetRequirementService: DatasetRequirementService
    ) {}
    ...
    @Post("query")
    async find(
        @Body() queryParam: QueryParam<DatasetRequirement>
    ): Promise<Result<ValueFields<DatasetRequirement>[]>> {
        return await this.datasetRequirementService.find(queryParam)
    }
    ...
    async total(
        ...
        return await this.datasetRequirementService.total(queryParam)
    }
}
