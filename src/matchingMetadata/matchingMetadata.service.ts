 ...
 */
@Injectable()
export class MatchingMetadataService {
    /**
    ...
    async find(
        ...
        return await bgTask.context.datastore.matchingMetadata.find(
    ...
    async total(
        ...
        return await bgTask.context.datastore.matchingMetadata.total(
            queryParam.queryFilter
        )
    }
}
